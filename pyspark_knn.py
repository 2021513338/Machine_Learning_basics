...
# 定义KNN模型
knn = KNNClassifier(labelCol="label", featuresCol="scaledFeatures", predictionCol="prediction", topN=5)
...
# 输出结果
print("Result of k-NN, 100 times 10 fold:")
print("-----------------------------------")
