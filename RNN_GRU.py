...
def run_cross_validation(X, y, n_repeats,output_file):
    ...
    hidden_size = 64
    output_size = 1  # assuming binary classification (1 output)
    ...
    for repeats in range(n_repeats):
        ...
        for fold_idx, (train_index, test_index) in enumerate(kf.split(X)):
            ...
            model = GRU_RNN(input_size, hidden_size, output_size)
...
if __name__ == "__main__":
    ...
    output_file = 'rnn_homo_DC_pDC.txt'
    run_cross_validation(X, y, 1, output_file)